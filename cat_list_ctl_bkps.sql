...
SELECT SESSION_KEY, SESSION_STAMP, TO_CHAR(P.COMPLETION_TIME,'DD/MM/YYHH24:MI')CREATION_TIME, 
       HANDLE, FILESIZE_DISPLAY, ROUND(ELAPSED_SECONDS)ELAPSED_SECONDS, STATUS, IS_RECOVERY_DEST_FILE,
       CHECKPOINT_CHANGE# ||'' CHECKPOINT_CHANGE
FROM RC_BACKUP_CONTROLFILE_DETAILS C, RC_BACKUP_PIECE P
