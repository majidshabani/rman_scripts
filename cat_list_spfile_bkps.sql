...
,FILESIZE_DISPLAY SPFILE_SIZE, TO_CHAR(MODIFICATION_TIME,'YYYY-MM-DD
HH24:MI:SS')MODIFICATION_TIME
FROM RMAN.RC_BACKUP_SET_DETAILS S, RMAN.RC_BACKUP_PIECE P,
RMAN.RC_BACKUP_SPFILE_DETAILS SP
